...
import utils
from nncls.data.sampler import RASampler
from nncls.models import get_model, get_weight
from nncls.data.transforms.presets import ClassificationPresetTrain, ClassificationPresetEval
from nncls.data.transforms import RandomMixup, RandomCutmix
...
def main(args):
    if args.weights:
        args.weights = get_weight(args.model, args.weights)
    if args.output_dir:
